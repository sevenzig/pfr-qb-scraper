#!/usr/bin/env python3
"""
Simple test for the fixed splits extractor using CLI infrastructure
"""
...
try:
    from cli.commands.scrape_command import ScrapeCommand
...
def test_splits_extraction():
    """Test the splits extraction functionality"""
    logger.info("Testing splits extraction")
...
if __name__ == "__main__":
    logger.info("Starting simple splits extractor test")
    result = test_splits_extraction()
